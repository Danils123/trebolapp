...
import com.cenfotec.trebol.security.SecurityUtils;
import com.cenfotec.trebol.service.dto.UserDTO;
import com.cenfotec.trebol.service.util.RandomUtil;
...
public class UserService {
    ...
    public User registerUser(UserDTO userDTO, String password, int rolNumber) {
        ...
        authorityRepository.findById(AuthoritiesConstants.getAuthoritiesConstants(rolNumber)).ifPresent(authorities::add);
