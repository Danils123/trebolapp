        ...
        var AdminMenu = function() {
            ...
            AdminMenu.prototype.init = function init() {
                ...
                $(document).on("click", "#sidebarnav", function(e) {
                    ...
                    $("#sidebarnav li").has("ul").children("a").on("click", function(e) {
                        var _this = $(this);
                ...
                // console.log([this._config.parentTrigger, this._config.subMenu, this._config.triggerElement, Event.CLICK_DATA_API]);
